 ...
 */
    ...
    public void insertar(Cliente cliente) {
        ...
        public static boolean guardarUsuario(Lista_Usuario listaUsuario) {
            try {
                String filename = "listaClientes.sar";
                ...
                if (nodoAux.getDato().getIdentificacion().equals(identificacion)) {
                    ...
                    while (opcion != 8) {
                        String menu = "Menú de Modificación de Propiedades del Cliente\n"
                                ...
                                + "3. Modificar correo\n"                //No se si se debe modificar contra ? 
